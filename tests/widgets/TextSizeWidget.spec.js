...
import { WIDGETS_NS, SET_TEXT_SIZE } from "@/store/constants";
...
describe("TextSizeWidget.vue", () => {
  ...
  it('updates the "readerTextSize" appropriately', () => {
    ...
    expect(store.state[WIDGETS_NS].readerTextSize).toBe("xs");
    expect(store.state[WIDGETS_NS].readerTextWidth).toBe("normal");
