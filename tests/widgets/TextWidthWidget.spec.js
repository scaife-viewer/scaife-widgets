...
describe("TextWidthWidget.vue", () => {
  it('updates the "textWidth" appropriately', () => {
    ...
    expect(store.state[WIDGETS_NS].readerTextWidth).toContain("normal");
    ...
    expect(store.state[WIDGETS_NS].readerTextWidth).toContain("wide");
    expect(narrowSpan.html()).toContain(
      'class="text-width-control">Narrow</span>'
    );
    expect(normalSpan.html()).toContain(
    ...
    expect(store.state[WIDGETS_NS].readerTextWidth).toContain("narrow");
    expect(narrowSpan.html()).toContain(
    ...
    expect(store.state[WIDGETS_NS].readerTextWidth).toContain("full");
    expect(narrowSpan.html()).toContain(
      'class="text-width-control">Narrow</span>'
    );
    expect(normalSpan.html()).toContain(
